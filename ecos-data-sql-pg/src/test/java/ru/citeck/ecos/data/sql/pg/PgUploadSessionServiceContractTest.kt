...
import ru.citeck.ecos.data.sql.test.content.UploadSessionServiceContractTest
...
/**
 * Runs the shared [UploadSessionServiceContractTest] against the PostgreSQL backend (via
 ...
 */
class PgUploadSessionServiceContractTest : UploadSessionServiceContractTest() {
    ...
    override fun createDataSource(): DbDataSource {
        val container = TestContainers.getPostgres(PgUploadSessionServiceContractTest::class.java)
        postgres = container
