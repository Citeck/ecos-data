...
/**
 * Runs the shared [UploadSessionServiceContractTest] against the in-memory backend. The only
 * backend-specific code is the factory + data source supplied here.
 */
class InMemUploadSessionServiceContractTest : UploadSessionServiceContractTest() {
