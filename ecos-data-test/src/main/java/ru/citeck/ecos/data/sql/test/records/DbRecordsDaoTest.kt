...
class DbRecordsDaoTest : DbRecordsTestBase() {
    ...
    fun schemaMockTest() {
        ...
        // asserts on the SQL DDL text of the migration commands (CREATE TABLE / ALTER TABLE), which
        // only a real SQL backend produces - the in-mem backend registers non-SQL change markers.
