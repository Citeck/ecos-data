...
class DbRecordsYamlDataTest : DbRecordsTestBase() {
    ...
    companion object {
        ...
        const val DATE_TIME_VALUE = "2022-04-11T00:00:00Z"
        const val TEXT_VALUE = "<camel:route>\n" +
    ...
    fun test() {
        ...
        val ref = createRecord(ATT_TEXT to TEXT_VALUE, ATT_DATETIME to DATE_TIME_VALUE, ATT_NUMBER to NUMBER_VALUE)
        ...
        assertThat(data[ATT_NUMBER].asInt()).isEqualTo(NUMBER_VALUE)
        assertThat(data[ATT_TEXT].asText()).isEqualTo(TEXT_VALUE)
        assertThat(data[ATT_DATETIME].asText()).isEqualTo(DATE_TIME_VALUE)
    }
}
